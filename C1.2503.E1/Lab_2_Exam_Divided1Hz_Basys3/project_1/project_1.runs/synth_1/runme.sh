...
HD_PWD='C:/Users/hkngu/Documents/Vivado/C1.2503.E1/Divided1Hz_Basys3/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_divider_1hz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_divider_1hz.tcl
