...
REM
REM Generated by Vivado on Thu Aug 21 19:41:05 +0700 2025
...
echo "xvlog --incr --relax -prj freq_div_100Mhz_to_1Hz_tb_vlog.prj"
call xvlog  --incr --relax -prj freq_div_100Mhz_to_1Hz_tb_vlog.prj -log xvlog.log
