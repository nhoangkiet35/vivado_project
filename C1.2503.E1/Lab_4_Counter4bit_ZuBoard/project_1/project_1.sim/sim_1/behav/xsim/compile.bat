...
REM
REM Generated by Vivado on Sat Aug 23 19:57:09 +0700 2025
...
echo "xvlog --incr --relax -prj counter_4bit_tb_vlog.prj"
call xvlog  --incr --relax -prj counter_4bit_tb_vlog.prj -log xvlog.log
