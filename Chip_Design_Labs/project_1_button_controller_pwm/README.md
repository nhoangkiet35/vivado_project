...
Giờ mình sẽ giải thích kỹ, để bạn hiểu tại sao chỉ pwm\_generator dùng clk\_1kHz, còn các module khác vẫn dùng clk 100 MHz nhé 👇

## ⚙️ 1️⃣ Tổng quan

Trong hệ thống top\_pwm của bạn, hiện có hai loại clock:
