...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Chip_Design_Labs/project_asm_1_rotary_alu_7seg_controller/project_asm_1_rotary_alu_7seg_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_calculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_calculator.tcl
