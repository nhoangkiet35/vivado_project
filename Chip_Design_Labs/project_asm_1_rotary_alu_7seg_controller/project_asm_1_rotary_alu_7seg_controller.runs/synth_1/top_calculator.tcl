...
synth_design -top top_calculator -part xc7z020clg400-1
...
write_checkpoint -force -noxdef top_calculator.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file top_calculator_utilization_synth.rpt -pb top_calculator_utilization_synth.pb"  } 
