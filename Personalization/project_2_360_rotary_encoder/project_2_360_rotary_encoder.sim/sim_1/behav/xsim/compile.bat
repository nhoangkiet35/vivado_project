...
REM
REM Generated by Vivado on Tue Oct 21 21:18:44 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj rotary_360_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj rotary_360_tb_vlog.prj -log xvlog.log
