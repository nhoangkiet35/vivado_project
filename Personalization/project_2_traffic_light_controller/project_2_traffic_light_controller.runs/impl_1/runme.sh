...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Chip_Design_Labs/project_2_traffic_light_controller/project_2_traffic_light_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_traffic_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_traffic_light.tcl -notrace
