...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Chip_Design_Labs/project_2_traffic_light_controller/project_2_traffic_light_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_traffic_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_traffic_light.tcl
