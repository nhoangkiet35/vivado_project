...
REM
REM Generated by Vivado on Thu Oct 30 16:01:50 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_traffic_light_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_traffic_light_vlog.prj -log xvlog.log
