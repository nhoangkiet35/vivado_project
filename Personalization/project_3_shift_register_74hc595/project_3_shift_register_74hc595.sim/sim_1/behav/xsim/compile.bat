...
REM
REM Generated by Vivado on Sat Oct 25 10:01:13 +0700 2025
...
echo "xvlog --incr --relax -prj tb_sevenseg_driver_fade_vlog.prj"
call xvlog  --incr --relax -prj tb_sevenseg_driver_fade_vlog.prj -log xvlog.log
