...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Personalization/project_4_rotary_shift_register/project_4_rotary_shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rotary_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rotary_7seg.tcl -notrace
