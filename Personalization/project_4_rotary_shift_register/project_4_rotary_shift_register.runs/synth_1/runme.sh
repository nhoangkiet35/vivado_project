...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Personalization/project_4_rotary_shift_register/project_4_rotary_shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rotary_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rotary_7seg.tcl
