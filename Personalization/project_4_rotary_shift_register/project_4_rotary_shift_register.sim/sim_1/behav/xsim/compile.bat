...
REM
REM Generated by Vivado on Sat Oct 25 14:57:39 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_rotary_encoder_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_rotary_encoder_vlog.prj -log xvlog.log
