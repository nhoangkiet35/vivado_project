...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Personalization/project_5_lcd1602_8_pynq/project_5_lcd1602_8_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd1602.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lcd1602.tcl -notrace
