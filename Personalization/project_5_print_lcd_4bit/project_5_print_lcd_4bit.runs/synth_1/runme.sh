...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Personalization/project_5_print_lcd_4bit/project_5_print_lcd_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lcd1602.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lcd1602.tcl
