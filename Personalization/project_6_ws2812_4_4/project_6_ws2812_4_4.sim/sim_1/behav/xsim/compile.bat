...
REM
REM Generated by Vivado on Wed Nov 05 00:53:12 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_ws2812_rainbow_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_ws2812_rainbow_vlog.prj -log xvlog.log
