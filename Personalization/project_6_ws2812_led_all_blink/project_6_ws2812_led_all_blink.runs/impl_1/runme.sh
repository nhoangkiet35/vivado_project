...
HD_PWD='C:/Users/hkngu/Documents/Vivado/Personalization/project_6_ws2812_led_all_blink/project_6_ws2812_led_all_blink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_master_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_master_top.tcl -notrace
