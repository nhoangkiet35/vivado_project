...
REM
REM Generated by Vivado on Sat Sep 27 15:30:14 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj t_ff_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj t_ff_tb_vlog.prj -log xvlog.log
