...
REM
REM Generated by Vivado on Sat Sep 27 16:55:44 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj ripple_counter_4bit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ripple_counter_4bit_tb_vlog.prj -log xvlog.log
