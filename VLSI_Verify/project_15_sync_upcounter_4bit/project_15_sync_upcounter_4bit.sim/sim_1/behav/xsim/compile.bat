...
REM
REM Generated by Vivado on Sat Sep 27 18:24:22 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj sync_upcounter_4bit_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj sync_upcounter_4bit_tb_vlog.prj -log xvlog.log
