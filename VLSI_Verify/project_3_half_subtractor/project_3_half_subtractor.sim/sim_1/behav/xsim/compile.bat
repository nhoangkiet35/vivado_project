...
REM
REM Generated by Vivado on Sat Sep 20 17:50:53 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj half_subtractor_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj half_subtractor_tb_vlog.prj -log xvlog.log
