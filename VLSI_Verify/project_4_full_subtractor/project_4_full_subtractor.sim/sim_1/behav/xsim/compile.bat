...
REM
REM Generated by Vivado on Sat Sep 20 18:11:33 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj full_subtractor_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj full_subtractor_tb_vlog.prj -log xvlog.log
