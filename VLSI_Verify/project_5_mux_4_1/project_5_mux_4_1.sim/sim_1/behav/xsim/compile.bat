...
REM
REM Generated by Vivado on Wed Sep 24 20:57:04 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj mux_4_1_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mux_4_1_tb_vlog.prj -log xvlog.log
