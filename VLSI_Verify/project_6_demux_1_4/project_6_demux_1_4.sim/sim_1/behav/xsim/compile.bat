...
REM
REM Generated by Vivado on Wed Sep 24 22:20:05 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj demux_1_4_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj demux_1_4_tb_vlog.prj -log xvlog.log
