...
REM
REM Generated by Vivado on Wed Sep 24 23:39:51 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj encoder_4_2_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj encoder_4_2_tb_vlog.prj -log xvlog.log
