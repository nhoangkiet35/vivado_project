...
REM
REM Generated by Vivado on Thu Sep 25 15:20:32 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj decoder_2_4_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj decoder_2_4_tb_vlog.prj -log xvlog.log
