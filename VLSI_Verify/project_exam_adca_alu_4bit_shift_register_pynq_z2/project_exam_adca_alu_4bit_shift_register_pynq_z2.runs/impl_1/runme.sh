...
HD_PWD='C:/Users/hkngu/Documents/Vivado/VLSI_Verify/project_exam_adca_alu_4bit_shift_register_pynq_z2/project_exam_adca_alu_4bit_shift_register_pynq_z2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_display_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_display_top.tcl -notrace
