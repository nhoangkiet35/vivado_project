...
HD_PWD='C:/Users/hkngu/Documents/Vivado/VLSI_Verify/project_exam_adca_alu_4bit_shift_register_pynq_z2/project_exam_adca_alu_4bit_shift_register_pynq_z2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_display_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_display_top.tcl
