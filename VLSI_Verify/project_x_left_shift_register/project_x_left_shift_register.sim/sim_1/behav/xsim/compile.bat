...
REM
REM Generated by Vivado on Thu Sep 25 21:26:16 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj left_shift_register_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj left_shift_register_tb_vlog.prj -log xvlog.log
