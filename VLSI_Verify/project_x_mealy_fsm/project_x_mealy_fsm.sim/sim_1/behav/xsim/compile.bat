...
REM
REM Generated by Vivado on Thu Oct 02 21:28:51 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj mealy_fsm_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mealy_fsm_tb_vlog.prj -log xvlog.log
