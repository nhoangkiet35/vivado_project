...
REM
REM Generated by Vivado on Thu Sep 25 20:56:13 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj right_shift_register_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj right_shift_register_tb_vlog.prj -log xvlog.log
