...
HD_PWD='C:/Users/hkngu/Documents/GitHub/Embedded-Software-The-Practical-Guide/Github/getting-started-with-fpgas-pynqz2/project_4_debounce/project_4_debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log debounce_project_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source debounce_project_top.tcl
