...
REM
REM Generated by Vivado on Wed Oct 22 12:52:57 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_debounce_project_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_debounce_project_top_vlog.prj -log xvlog.log
