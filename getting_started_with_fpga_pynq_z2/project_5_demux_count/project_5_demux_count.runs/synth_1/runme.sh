...
HD_PWD='C:/Users/hkngu/Documents/GitHub/Embedded-Software-The-Practical-Guide/Github/getting-started-with-fpgas-pynqz2/project_5_demux_count/project_5_demux_count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demux_count_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demux_count_top.tcl
