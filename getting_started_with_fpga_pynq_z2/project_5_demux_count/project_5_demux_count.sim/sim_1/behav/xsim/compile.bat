...
REM
REM Generated by Vivado on Wed Oct 22 13:34:40 +0700 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_demux_count_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_demux_count_top_vlog.prj -log xvlog.log
